...
import { getAboutUs, updateAboutUs } from "../services/editableService";
...
class About extends Component {
  ...
  submitChanges = () => {
    updateAboutUs(this.state.user, this.state.text);
  };
  ...
  render() {
    return (
      <MDBContainer className="Home" style={{ paddingTop: "50px" }}>
        <img
          src={process.env.PUBLIC_URL + "/images/clubBanner.png"}
          alt="Rotary Club of Grand Junction banner"
          style={{ margin: "auto" }}
        />
        {this.state.loading ? (
